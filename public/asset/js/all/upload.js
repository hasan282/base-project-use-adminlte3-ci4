...
(function ($) {
    ...
    $.fn.setDropZone = function (url) {
        ...
        this.html('<form action="' + url + '" class="dropzone text-center" style="border-color:#F2F2F2;border-radius:15px">' + INNERNOW + '</form>');
        ...
        myDropzone.on("success", function (file, response) {
            ...
            $('#uploadmsg').html('<small class="text-' + messagecolor + '">' + response.message + '</small>')
        });
